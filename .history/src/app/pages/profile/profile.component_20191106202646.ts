  ...
  ngOnInit() {
   ...
   notification(type) {
    ...
    populateForm(pro : Profile) {
      this.service.currentuser = Object.assign({}, pro);
    }
    ...
    updateRecord(form: NgForm) {
      this.service.currentuser.putProfile(form.value).subscribe(res => {
        this.resetForm(form);
        this.service.currentuser.refreshList();
      });
    }
    ...
    insertRecord(form: NgForm) {
      this.service.currentuser.postProfile(form.value).subscribe(res => {
